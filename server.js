...
<html>
<head><meta charset="utf-8"><title>Photo to Email</title>
<style>body{font-family:sans-serif;text-align:center;padding:40px;background:#f0f0f0;}
h1{color:#333;}p{color:#555;font-size:18px;}</style>
</head>
<body>
...
class PhotoEmailApp extends AppServer {
              constructor() {
                ...
                // Add /webview route directly on the Hono app (AppServer extends Hono)
                this.get('/webview', (c) => {
                                  return c.html(WEBVIEW_HTML);
                });
              }
  ...
  async onSession(session, sessionId, userId) {
                ...
                session.events.onButtonPress(async (buttonEvent) => {
                                  console.log('Button pressed! Type:', buttonEvent.type);
                                    ...
                                    // photo.buffer contains the actual image bytes
                                    let base64Data;
                                                                       ...
                                                                       if (Buffer.isBuffer(buf)) {
                                                                                             ...
                                                                                             // Try converting object values (in case it's an array-like object)
